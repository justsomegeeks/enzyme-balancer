...
contract BalancerV2PriceFeed {
    ...
    constructor(address _balancerV2Vault) public {
        ...
        tokenAggregator[0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599] = Aggregator(
            0xF4030086522a5bEEa4988F8cA5B36dbC97BeE88c,
            true
        ); //btc_usd
        tokenAggregator[0xD533a949740bb3306d119CC777fa900bA034cd52] = Aggregator(
            0xCd627aA160A6fA45Eb793D19Ef54f5062F20f33f,
            true
        ); //crv_usd
        tokenAggregator[0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e] = Aggregator(
            0xA027702dbb89fbd58938e4324ac03B58d812b0E1,
            true
        ); //yfi_usd
        tokenAggregator[0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984] = Aggregator(
            0xD6aA3D25116d8dA79Ea0246c4826EB951872e02e,
            true
        ); //uni_usd
        tokenAggregator[0xba100000625a3754423978a60c9317c58a424e3D] = Aggregator(
