...
/// @title BalancerV2PoolTokenValueCalculator Contract
/// @author Enzyme Council <security@enzyme.finance>
/// @notice Abstract contract for computing the value of Balancer liquidity pool tokens
/// @dev Unless otherwise noted, these functions are adapted to our needs and style guide from
/// an un-merged Balancer branch:
...
abstract contract BalancerV2PoolTokenValueCalculator {
    ...
    /// @dev Given a Balancer pool with token0 and token1 and their trusted rate,
